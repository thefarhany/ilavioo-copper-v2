...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#52796f]">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-[#84a98c]/20 blur-[120px]" />
      <div className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full bg-[#52796f]/30 blur-[100px]" />
      ...
      <motion.div
        className="absolute top-16 right-[15%] w-3 h-3 rounded-full bg-white/30"
        animate={{ y: [0, -12, 0], opacity: [0.3, 0.6, 0.3] }}
        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute bottom-20 left-[10%] w-2 h-2 rounded-full bg-white/20"
        animate={{ y: [0, -8, 0], opacity: [0.2, 0.4, 0.2] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 2 }}
      />
      <motion.div
        className="absolute top-1/3 right-[8%] w-2 h-2 rounded-full bg-white/25"
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-8 md:py-12">
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            Premium Copper &amp;
            <span className="block italic mt-1">Brass Products</span>
          </motion.h1>
          ...
          >
            Discover our extensive collection of handcrafted copper and brass products, 
            engineered for durability, beauty, and timeless elegance.
          </motion.p>
        </div>
      </div>
