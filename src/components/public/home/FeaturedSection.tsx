...
export function FeaturedSection() {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-gradient-to-br from-[#A0522D]/5 via-[#F5F0E8]/30 to-[#3E2723]/5">
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#F5F0E8] to-transparent opacity-60 pointer-events-none" />
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
          ...
          >
            ...
            >
              Featured <span className="text-[#C5A059] italic">Products</span>
            </h2>
          </motion.div>
          <Link 
            href="/products" 
